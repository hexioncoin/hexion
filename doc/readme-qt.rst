...
A warning for people using the *static binary* version of Hexion on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Hexion is linked against libdb 5.0 (see also `this Debian issue`_).
